...
--Alpha Company--
ctld.preLoadTransport("6-6/A", AA_SQUAD, true)
ctld.preLoadTransport("6-5/A", AA_SQUAD, true)
--Alpha 1st plt--
...
--Alpha Support plt--
ctld.preLoadTransport("5-1/A", MORTAR_SQUAD, true)
ctld.preLoadTransport("5-3/A", MORTAR_SQUAD, true)

--Bravo Company--
ctld.preLoadTransport("6-6/B", AA_SQUAD, true)
ctld.preLoadTransport("6-5/B", AA_SQUAD, true)
--Bravo 1st plt--
...
--Bravo Support plt--
ctld.preLoadTransport("5-1/B", MORTAR_SQUAD, true)
ctld.preLoadTransport("5-3/B", MORTAR_SQUAD, true)
